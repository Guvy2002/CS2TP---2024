    ...
    <div class="dashboard-container">
        <div class="dashboard-header">
            ...
            <div class="admin-controls">
                ...
                <a href="customer_management.php" class="btn btn-primary">
        ...
        <?php if ($customerFilter): ?>
            <div class="customer-filter-notice">
                <p><i class="fas fa-user"></i> Showing orders for: <strong><?php echo htmlspecialchars($customerName); ?> (ID: <?php echo $customerFilter; ?>)</strong></p>
        ...
        <form method="GET" class="search-filter-container">
            ...
            <a href="admin_orders.php<?php echo $customerFilter ? '?customer=' . $customerFilter : ''; ?>" class="btn btn-secondary">
            ...
            <div class="table-container">
                        ...
                        <thead>
                            <tr>
                                <th width="7%" class="text-center">
                                    <a href="<?php echo buildPaginationUrl(1, $itemsPerPage, 'o.orderID', getNextOrder('o.orderID', $order, $orderBy), $search, $customerFilter, $statusFilter, $startDate, $endDate); ?>">
                                        Order ID
                                ...
                                <th width="25%">
                                    <a href="<?php echo buildPaginationUrl(1, $itemsPerPage, 'c.fullName', getNextOrder('c.fullName', $order, $orderBy), $search, $customerFilter, $statusFilter, $startDate, $endDate); ?>">
                                        Customer
                                ...
                                <th width="15%">
                                    <a href="<?php echo buildPaginationUrl(1, $itemsPerPage, 'o.orderDate', getNextOrder('o.orderDate', $order, $orderBy), $search, $customerFilter, $statusFilter, $startDate, $endDate); ?>">
                                        Date
                                ...
                                <th width="15%" class="text-right">
                                    <a href="<?php echo buildPaginationUrl(1, $itemsPerPage, 'o.totalPrice', getNextOrder('o.totalPrice', $order, $orderBy), $search, $customerFilter, $statusFilter, $startDate, $endDate); ?>">
                                        Total
                                ...
                                <th width="15%" class="text-center">
                                    <a href="<?php echo buildPaginationUrl(1, $itemsPerPage, 'o.orderStatus', getNextOrder('o.orderStatus', $order, $orderBy), $search, $customerFilter, $statusFilter, $startDate, $endDate); ?>">
                                        Status
                            ...
                            <?php while ($order = $orders->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td class="actions-column">
                                        <button onclick="editOrderStatus(<?php echo $order['orderID']; ?>, '<?php echo $order['orderStatus']; ?>')" 
                ...
                <div class="pagination">
                    <div class="pagination-info">
                        Showing <?php echo $offset + 1; ?> to <?php echo min($offset + $itemsPerPage, $totalOrders); ?> of 
                        <?php echo $totalOrders; ?> orders
                    </div>
                    <div class="pagination-controls">
                        <?php if ($totalPages > 1): ?>
                            <?php if ($currentPage > 1): ?>
                                <a href="<?php echo buildPaginationUrl($currentPage - 1, $itemsPerPage, $orderBy, $order, $search, $customerFilter, $statusFilter, $startDate, $endDate); ?>" class="btn">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="">
                ...
                <div class="status-note">
                    <p><strong>Note:</strong> Changing status to 'Shipped' will automatically set today's date as the shipping date.</p>
                </div>
