...
<div class="navbar">
    ...
    <ul>
        ...
        <li><a href="ps5.html">Sony</a></li>
        <li><a href="XBOX Product Page.html">Microsoft</a></li>
        <li><a href="PC Product Page.html">PC</a></li>
        <li><a href="vrstore.html">VR</a></li>
        <li><a href="#pc">Pre-order</a></li>
        <li><a href="#pc">Special Bundles</a></li>
    </ul>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        // Function to update the order summary totals
        function updateTotals() {
            ...
            basketItems.forEach(item => {
                // Get the price (remove £ symbol and convert to number)
            ...
            const subtotalDisplay = document.querySelector('.basket-summary div:nth-child(2) span:last-child');
            const totalDisplay = document.querySelector('.basket-summary div:nth-child(5) span:last-child');

            subtotalDisplay.textContent = `£${subtotal.toFixed(2)}`;
            totalDisplay.textContent = `£${subtotal.toFixed(2)}`; // Same as subtotal since shipping is free
        }
